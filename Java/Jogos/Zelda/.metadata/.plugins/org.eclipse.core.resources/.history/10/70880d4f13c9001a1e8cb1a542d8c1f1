			...
			for(int xx = 0; xx< map.getWidth(); xx++) {
				...
				for(int yy = 0; yy < map.getHeight(); yy++) {
					...
					if(pixelA == 0xFFFF00DC) {
						...
						Game.entities.add(new Weapontwo(xx*TILE_SIZE,yy*TILE_SIZE,TILE_SIZE,TILE_SIZE,Entity.WEAPONTWO_EN));
					}else if(pixelA == 0xFFFF0000) {
						Game.entities.add(new Enemy(xx*TILE_SIZE,yy*TILE_SIZE,TILE_SIZE,TILE_SIZE,Entity.ENEMI_EN));
