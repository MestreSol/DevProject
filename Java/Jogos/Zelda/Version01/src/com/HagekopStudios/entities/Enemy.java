...
public class Enemy extends Entity{
	...
	public void tick(){
		...
		//Caso nao exista colizão entre o player e o inimigo, o inimigo devera andar até o player
		if(!isColiddingWithPlayer()){
			
			//Verifica a posição do jogador em relação ao inimigo para movimentalo, verifica tambem se ele esta colidindo com algo, Verifica a distancia que o inimigo esta do jogador
