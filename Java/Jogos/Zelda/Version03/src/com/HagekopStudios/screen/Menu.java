...
import com.HagekopStudios.gfx.Color;
import com.HagekopStudios.gfx.Font;
import com.HagekopStudios.gfx.Screen;
import com.HagekopStudios.main.Game;
import com.HagekopStudios.main.GetsInput;

public class Menu {
	protected Game game;
	protected GetsInput input;
	
	public void init(Game game, GetsInput input) {
		this.input = input;
		this.game = game;
	}
	public void tick() {}
